import sys
sys.path.append('/home/ysy/ysy/workspace/diffusion_models/video_diffusion/video-diffusion-mcvdunet/datasets')
sys.path.append('/home/ysy/ysy/workspace/diffusion_models/video_diffusion/video-diffusion-mcvdunet')
import numpy as np
import torch
import os
...
def data_load(data_root, stage, batch_size, num_workers, frames_per_sample=14, random_time=True, random_horizontal_flip=True, color_jitter=0,
    ...
    dataset = Cityscapes(data_path, frames_per_sample=frames_per_sample, random_time=random_time, random_horizontal_flip=random_horizontal_flip, color_jitter=color_jitter, total_videos=total_videos)
